"use strict";(()=>{var L={DARK:{"--panel-bg":"#0c0d13","--text-primary":"#ffffff","--text-secondary":"rgba(255,255,255,0.45)","--text-muted":"rgba(255,255,255,0.28)","--header-border":"rgba(255,255,255,0.07)","--bubble-agent-bg":"rgba(255,255,255,0.06)","--bubble-agent-border":"rgba(255,255,255,0.06)","--bubble-agent-text":"#f2f3f7","--input-bg":"rgba(255,255,255,0.06)","--input-border":"rgba(255,255,255,0.1)","--input-focus-bg":"rgba(255,255,255,0.08)","--input-text":"#ffffff","--input-placeholder":"rgba(255,255,255,0.32)","--composer-border":"rgba(255,255,255,0.07)","--composer-bg":"rgba(255,255,255,0.02)","--close-icon":"rgba(255,255,255,0.4)","--close-hover-bg":"rgba(255,255,255,0.08)","--footer-text":"rgba(255,255,255,0.25)","--footer-brand-text":"rgba(255,255,255,0.4)","--scrollbar-thumb":"rgba(255,255,255,0.12)","--panel-shadow":"0 24px 70px rgba(0,0,0,0.5), 0 4px 16px rgba(0,0,0,0.3), 0 0 0 1px rgba(255,255,255,0.07) inset","--header-glow":"rgba(114,136,255,0.25)"},MIDNIGHT:{"--panel-bg":"#05060d","--text-primary":"#eef0ff","--text-secondary":"rgba(238,240,255,0.45)","--text-muted":"rgba(238,240,255,0.28)","--header-border":"rgba(238,240,255,0.08)","--bubble-agent-bg":"rgba(238,240,255,0.06)","--bubble-agent-border":"rgba(238,240,255,0.06)","--bubble-agent-text":"#eef0ff","--input-bg":"rgba(238,240,255,0.06)","--input-border":"rgba(238,240,255,0.1)","--input-focus-bg":"rgba(238,240,255,0.09)","--input-text":"#eef0ff","--input-placeholder":"rgba(238,240,255,0.32)","--composer-border":"rgba(238,240,255,0.08)","--composer-bg":"rgba(238,240,255,0.02)","--close-icon":"rgba(238,240,255,0.4)","--close-hover-bg":"rgba(238,240,255,0.08)","--footer-text":"rgba(238,240,255,0.25)","--footer-brand-text":"rgba(238,240,255,0.4)","--scrollbar-thumb":"rgba(238,240,255,0.12)","--panel-shadow":"0 24px 70px rgba(0,0,0,0.6), 0 4px 16px rgba(0,0,0,0.4), 0 0 0 1px rgba(238,240,255,0.06) inset","--header-glow":"rgba(114,136,255,0.3)"},LIGHT:{"--panel-bg":"#ffffff","--text-primary":"#0f1330","--text-secondary":"rgba(15,19,48,0.55)","--text-muted":"rgba(15,19,48,0.4)","--header-border":"rgba(15,19,48,0.08)","--bubble-agent-bg":"rgba(15,19,48,0.045)","--bubble-agent-border":"rgba(15,19,48,0.07)","--bubble-agent-text":"#0f1330","--input-bg":"rgba(15,19,48,0.035)","--input-border":"rgba(15,19,48,0.12)","--input-focus-bg":"rgba(15,19,48,0.05)","--input-text":"#0f1330","--input-placeholder":"rgba(15,19,48,0.38)","--composer-border":"rgba(15,19,48,0.08)","--composer-bg":"rgba(15,19,48,0.015)","--close-icon":"rgba(15,19,48,0.45)","--close-hover-bg":"rgba(15,19,48,0.06)","--footer-text":"rgba(15,19,48,0.32)","--footer-brand-text":"rgba(15,19,48,0.5)","--scrollbar-thumb":"rgba(15,19,48,0.14)","--panel-shadow":"0 24px 70px rgba(20,27,77,0.16), 0 4px 16px rgba(20,27,77,0.1), 0 0 0 1px rgba(15,19,48,0.06) inset","--header-glow":"rgba(114,136,255,0.14)"},PERIWINKLE:{"--panel-bg":"#f8f9ff","--text-primary":"#1f2568","--text-secondary":"rgba(31,37,104,0.55)","--text-muted":"rgba(31,37,104,0.4)","--header-border":"rgba(31,37,104,0.09)","--bubble-agent-bg":"rgba(31,37,104,0.05)","--bubble-agent-border":"rgba(31,37,104,0.08)","--bubble-agent-text":"#1f2568","--input-bg":"rgba(31,37,104,0.04)","--input-border":"rgba(31,37,104,0.14)","--input-focus-bg":"rgba(31,37,104,0.06)","--input-text":"#1f2568","--input-placeholder":"rgba(31,37,104,0.4)","--composer-border":"rgba(31,37,104,0.09)","--composer-bg":"rgba(31,37,104,0.02)","--close-icon":"rgba(31,37,104,0.48)","--close-hover-bg":"rgba(31,37,104,0.07)","--footer-text":"rgba(31,37,104,0.34)","--footer-brand-text":"rgba(31,37,104,0.52)","--scrollbar-thumb":"rgba(31,37,104,0.15)","--panel-shadow":"0 24px 70px rgba(31,37,104,0.18), 0 4px 16px rgba(31,37,104,0.12), 0 0 0 1px rgba(31,37,104,0.07) inset","--header-glow":"rgba(114,136,255,0.2)"}};(function(){let u=document.currentScript,b=u?.dataset.agentId;if(!b){console.error("[chat-widget] missing data-agent-id on the embed <script> tag.");return}let x=u?.dataset.apiBase??new URL(u?.src??"",location.href).origin,v=`chat-agent:${b}`,f=JSON.parse(localStorage.getItem(v)??"{}"),y=f.sessionCookie??crypto.randomUUID(),m=f.conversationId;function M(){localStorage.setItem(v,JSON.stringify({conversationId:m,sessionCookie:y}))}let g=document.createElement("div");g.id="chat-agent-widget-root",document.body.appendChild(g);let n=g.attachShadow({mode:"open"});n.innerHTML=`
    <style>${$()}</style>
  ...
  `;let w=n.querySelector(".launcher"),p=n.querySelector(".panel"),S=n.querySelector(".close"),s=n.querySelector(".messages"),c=n.querySelector(".confirmation"),H=n.querySelector(".composer"),d=n.querySelector("input"),k=n.querySelector(".composer button"),z=n.querySelector(".name"),T=n.querySelector(".avatar"),B=n.querySelector(".avatar-fallback");d.addEventListener("input",()=>{k.disabled=d.value.trim().length===0});let i,h=!1;function N(e){let r=L[e??"DARK"];for(let[t,o]of Object.entries(r))g.style.setProperty(t,o)}async function D(){let e=await fetch(`${x}/v1/widget-config/${b}`);if(!e.ok)throw new Error(`widget-config fetch failed: ${e.status}`);i=await e.json(),N(i.theme),z.textContent=i.name,i.avatarUrl&&(T.src=i.avatarUrl,T.hidden=!1,B.hidden=!0),f.conversationId||l("agent",i.greeting)}let I;function C(e){h=e,clearTimeout(I),w.classList.toggle("open",e),e?(p.hidden=!1,requestAnimationFrame(()=>p.classList.add("open")),d.focus()):(p.classList.remove("open"),I=setTimeout(()=>{h||(p.hidden=!0)},200))}w.addEventListener("click",()=>C(!h)),S.addEventListener("click",()=>C(!1));function l(e,r){let t=document.createElement("div");t.className=`row ${e}`;let o=document.createElement("div");o.className=`bubble ${e}`,o.textContent=r;let a=document.createElement("div");a.className="timestamp",a.textContent=new Date().toLocaleTimeString([],{hour:"numeric",minute:"2-digit"}),t.append(o,a),s.appendChild(t),s.scrollTop=s.scrollHeight}function R(e){c.hidden=!1,c.innerHTML="";let r=document.createElement("div");r.className="confirmation-text",r.textContent=e.confirmationPrompt;let t=document.createElement("div");t.className="confirmation-actions";let o=document.createElement("button");o.textContent="Confirm",o.className="confirm",o.onclick=()=>{c.hidden=!0,E("",{confirmToolCallId:e.toolCallId})};let a=document.createElement("button");a.textContent="Cancel",a.className="cancel",a.onclick=()=>{c.hidden=!0,l("agent","No problem, I won't go ahead with that.")},t.append(o,a),c.append(r,t)}async function E(e,r){if(!i)return;e&&l("customer",e);let t=document.createElement("div");t.className="row agent",t.innerHTML='<div class="bubble agent typing"><span></span><span></span><span></span></div>',s.appendChild(t),s.scrollTop=s.scrollHeight;try{let o=await fetch(`${x}/v1/chat/${b}/messages`,{method:"POST",headers:{"content-type":"application/json",authorization:`Bearer ${i.widgetToken}`},body:JSON.stringify({conversationId:m,message:e||"(customer confirmed the pending action)",customerIdentifier:{type:"widget_session_cookie",value:y},...r})});if(t.remove(),!o.ok){l("agent","Sorry, I'm having trouble responding right now. Please try again shortly.");return}let a=await o.json();m=a.conversationId,M(),a.reply&&l("agent",a.reply),a.pendingConfirmation&&R(a.pendingConfirmation)}catch{t.remove(),l("agent","Sorry, I'm having trouble responding right now. Please try again shortly.")}}H.addEventListener("submit",e=>{e.preventDefault();let r=d.value.trim();r&&(d.value="",k.disabled=!0,E(r))}),D();function $(){return`
      ...
      :host {
        ...
        ${Object.entries(L.DARK).map(([e,r])=>`${e}: ${r};`).join(" ")}
      }
