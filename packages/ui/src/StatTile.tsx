...
export function StatTile({
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl2 border border-surface-border bg-surface-raised p-5 shadow-card transition-all duration-300 hover:-translate-y-0.5 hover:border-foreground/15 hover:shadow-card-hover">
