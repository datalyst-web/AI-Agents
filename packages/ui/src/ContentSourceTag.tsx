...
export function ContentSourceTag({ source }: { source: "CLIENT" | "STAFF_MANAGED_SETUP" }) {
  ...
  return (
    <span className="inline-flex items-center gap-1 rounded-full bg-brand-500/10 px-2 py-0.5 text-[11px] font-medium text-brand-300 ring-1 ring-inset ring-brand-500/25">
